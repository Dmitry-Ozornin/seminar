...
Console.Write("Введите исконное число: ");
...
if (c_Random == 0 && c_Count == 0)
{
    Console.WriteLine("Нет");
}
else
{
    if (c_Random > 0) Console.WriteLine($"Искомый элемент найден в массиве {new_mas}");
    if (c_Count > 0) Console.WriteLine($"Искомый элемент найден в массиве {new_mas_2}");
